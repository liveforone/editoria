...
import editoria.editoria.repository.UserRepository;
...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        } else if (users.getAuth() == Role.WRITER) {
            authorities.add(new SimpleGrantedAuthority(Role.WRITER.getValue()));
        }
    ...
    public void updateAuth (String email) {
        ...
        updatedAuthorities.add(new SimpleGrantedAuthority(Role.WRITER.getValue()));
